...
class PaymentActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btnEstadoCta = findViewById<Button>(R.id.btnEstadoCta)
        ...
        btnEstadoCta.setOnClickListener {
            val intent = Intent(this, StateActivity::class.java) //crea un intent para cambiar de activity
            startActivity(intent)
            finish()
        }
